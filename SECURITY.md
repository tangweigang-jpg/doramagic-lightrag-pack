...
This repository is an independent AI context resource pack for HKUDS/LightRAG. It is not LightRAG's official security contact.
...
Upstream product vulnerabilities should be reported to HKUDS/LightRAG's own security policy. Link the upstream advisory here only when this pack needs a mitigation or warning.
