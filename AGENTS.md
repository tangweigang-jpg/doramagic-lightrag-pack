...
Use this pack to help an AI coding agent work with `HKUDS/LightRAG` safely and verifiably.

## When To Use

- The user wants `load LightRAG architecture context, retrieval boundaries, graph-RAG setup notes, and acceptance checks into your AI host before building a RAG workflow`.
